...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:FFFFFF,50:E63946,100:8B0000&height=230&section=header&text=OPENWEBUI%20AUTOMATION&fontSize=52&fontColor=FFFFFF&fontAlignY=38&fontAlign=50&desc=End-to-End%20and%20AI-Native%20Quality%20Assurance%20Framework&descAlignY=60&descSize=17&descColor=FFE8E8&animation=fadeIn" width="100%"/>
...
- [Detailed Flow — System Architecture Diagram](#-detailed-flow--system-architecture-diagram)
...
## 🧭 Detailed Flow — System Architecture Diagram

The diagram above is the quick-read version. For the full picture — every component, data path, and integration point in one view — see the detailed architecture diagram below:

![Detailed System Architecture Diagram](https://drive.google.com/uc?export=view&id=1mY5UKGmaKjOww83TgGZoNNfBIi-M49Vo)

> **Note:** as with the dashboard image above, this Drive file needs to be shared as **"Anyone with the link"** for it to display correctly for anyone viewing the repo who isn't you.
...
![Allure Report Dashboard](https://drive.google.com/uc?export=view&id=1aq1u27OxEzAU4Qvw0t-XH5I1KPeRTxhX)

> **Note:** for this to render for every visitor (not just you), the Drive file must be shared as **"Anyone with the link"** — otherwise GitHub shows a broken-image icon to anyone who isn't already signed into an account with access.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:FFFFFF,50:E63946,100:8B0000&height=120&section=footer" width="100%"/>
